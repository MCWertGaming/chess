...
int main()
{
    ...
    chf.createPice(3,4,piceWhitePawn);
    ...
    chf.clearField();
    chf.createPice(3,1,piceWhitePawn);
    ...
    chf.clearField();
    chf.createPice(3,4,piceBlackPawn);
    ...
    chf.clearField();
    chf.createPice(3,6,piceBlackPawn);
    ...
    // check, if white pawn can access white pice
    chf.clearField();
    chf.createPice(4,1,piceWhitePawn);
    chf.createPice(4,2,piceWhiteKnight);
    chf.createPice(4,3,piceWhiteKing);
    chf.createPice(3,2,piceBlackKnight);
    chf.createPice(5,2,piceBlackKnight);
    chf.createPice(5,3,piceBlackKnight);
    chf.createPice(3,4,piceWhitePawn);
    chf.createPice(3,5,piceWhiteKnight);
    chf.createPice(3,6,piceWhiteKnight);
    chf.createPice(2,5,piceBlackBishop);
    chf.createPice(4,5,piceBlackBishop);
    chf.createPice(6,5,piceWhitePawn);
    chf.createPice(6,6,piceBlackBishop);
    chf.createPice(6,7,piceBlackBishop);
    chf.createPice(5,6,piceWhiteBishop);
    chf.createPice(7,6,piceWhiteBishop);
    ...
    chf.clearField();
    chf.createPice(2,2,piceBlackPawn);
    chf.createPice(4,4,piceWhitePawn);
    ...
    chf.clearField();
    chf.createPice(3,3,piceWhitePawn);
    chf.createPice(5,5,piceBlackPawn);
    ...
    // rook movement
    chf.clearField();
    chf.createPice(3,2,piceWhiteRook);
    chf.createPice(5,5,piceBlackRook);
    chf.createPice(3,5,piceWhitePawn);
    chf.createPice(5,2,piceBlackPawn);
    ...
    // test Bishop
    chf.clearField();
    chf.createPice(3,3,piceWhiteBishop);
    ...
    // test Knight
    chf.clearField();
    chf.createPice(3,3,piceWhiteKnight);
    ...
    // test king
    chf.clearField();
    chf.createPice(3,3,piceWhiteKing);
    ...
    // test Queen
    chf.clearField();
    chf.createPice(3,3,piceWhiteQueen);
    ...
    chf.clearField();
    chf.createPice(3,3,piceWhiteKing);
    chf.createPice(2,6,piceBlackRook);
    ...
    chf.createPice(3,6,piceBlackPawn);
    chf.createPice(3,1,piceWhitePawn);
    chf.createPice(3,5,piceBlackPawn);
    chf.createPice(3,2,piceBlackPawn);
    ...
    chf.clearField();
    chf.createPice(3,4,piceWhiteBishop);
    chf.createPice(1,2,piceWhitePawn);
    chf.createPice(2,5,piceBlackPawn);
    chf.createPice(5,6,piceBlackPawn);
    chf.createPice(5,2,piceBlackPawn);
